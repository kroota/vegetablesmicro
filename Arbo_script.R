...
###Kahe sekveneerimisandmete Shannon
...
library(VennDiagram)
grid.newpage()
draw.pairwise.venn(709, 636, 529, category = c("Esimeste proovide OTUde arv", "Teiste proovide OTUde arv"), lty = rep("blank", 2), fill = c("cadetblue2", "olivedrab2"), alpha = rep(0.5, 2), cat.pos = c(0, 
